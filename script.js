    ...
    return (
        <div className="create-page" style={{ maxWidth: '1000px', margin: '0 auto', padding: '40px 20px' }}>
            <button 
                ...
                style={{ marginBottom: '20px', padding: '8px 16px', background: '#888', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer' }}
            >
                ← 장르 다시 선택
            </button>
            
            <h1 className="page-title">{selectedGenre} 시나리오 작성하기</h1>
